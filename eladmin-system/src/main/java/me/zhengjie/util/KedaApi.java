...
public class KedaApi {
     ...
     */
    private static final String clientId = "1b2b51b4c7c0447988ca7a242603e8c0";
    private static final String clientSecret = "f143f55deae3499ab3de932140e5d97d";
     ...
     * 音频文件
     */
    public static String audioPath = "C:\\eladmin\\file\\MUSIC\\audio-2023111104333243.pcm";
    /**
    ...
    public static void getApi(String pcmFilePath) {
        String accessToken = getAccessToken();
        if (!accessToken.isEmpty()) {
            File audioFile = new File(pcmFilePath);
            ...
            if (audioFile.exists() && audioFile.length() < MAX_FILE_SIZE) {
                ...
                doSpeechRecognition(accessToken, audioFile, "wav", 16000);
            }
        }
    }
